...
def _resolve_document(supabase_client, user_id: str, doc_name: str):
    ...
    for d in (all_docs.data or []):
        ...
        # Substring-aware: a query token ("boiler") must match a longer
        # filename token ("boilers"), otherwise a generic shared word
        # ("water") wins the wrong file.
        score = sum(
            1 for t in tokens
        ...
        if tool_name == "search_documents":
            ...
            if not doc.data:
                if has_structured_data:
                    ...
                    # A doc-flavored question ("how often do the water
